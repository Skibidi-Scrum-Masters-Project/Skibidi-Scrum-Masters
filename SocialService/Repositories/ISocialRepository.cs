...
public interface ISocialRepository
{
    ...
    //Event handler der subscriber til SoloTraningService.CompleteTraning
    Task<string?> CreateDraftFromSoloTrainingCompletedAsync(SoloTrainingCompletedEventDto metric);
